...
public class ChannelSectionController implements Initializable {
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
        ...
        ObservableList<ChannelSectionController.SourceInfo> options = FXCollections.observableArrayList();
        Webcam webcam = Webcam.getDefault();
        ChannelSectionController.SourceInfo srcInfo = new ChannelSectionController.SourceInfo();
        srcInfo.setStreamSource(StreamSource.WebCamera);
        srcInfo.setsrcName(webcam.getName());
        options.add(srcInfo);

        srcInfo = new ChannelSectionController.SourceInfo();
        ...
        StreamOptions.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<ChannelSectionController.SourceInfo>() {

            @Override
            public void changed(ObservableValue<? extends ChannelSectionController.SourceInfo> arg0, ChannelSectionController.SourceInfo arg1, ChannelSectionController.SourceInfo arg2) {
                if (arg2 != null) {
    ...
    public void StartStream(ChannelSectionController.SourceInfo sourceInfo) {
